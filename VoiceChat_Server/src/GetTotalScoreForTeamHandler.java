 ...
 * @author Ian
 */
public class GetTotalScoreForTeamHandler implements HttpHandler{
    
    private final Server mainServer;

    public GetTotalScoreForTeamHandler(Server mainServer) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        int score = mainServer.getTotalScoreForTeam(teamName);
